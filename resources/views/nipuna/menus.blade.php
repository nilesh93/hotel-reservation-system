...
<div class="portlet-body">
 <div class="row" id="temptable">
        <table class="table table-striped table-bordered table-hover dataTables-example" id="dm" plugin="datatable" >
                ...
                <div class="modal-footer">
                    <button type="button" onclick="update_menu()" class="btn btn-primary" name="submit" >Update Menu</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </form>
                </div>
            </div>
    ...
    <div  class="modal fade" id="update_item_modal">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="quantity" class="col-lg-5 control-label">Item Name</label>
                            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="quantity" class="col-lg-5 control-label">Item Price</label>
                            <div class="col-lg-6">
                                <input class="form-control" id="item_price" placeholder="Item Price" type="text">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="update_menu()" class="btn btn-primary" name="submit" >Update Item Details</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </form>
                </div>
            </div>
    ...
    function detailedMenu(a){
        ...
        $('#dm').DataTable( {
            ...
            "columns": [
                ...
                {"data" : null,
                 "mRender": function(data, type, full) {
                     return '<button class="btn btn-info  btn-animate btn-animate-side btn-block btn-sm" onclick="edit_items('+data.id+')"> Edit </button>' ;
                 }
                },
                {"data" : null,
                 "mRender": function(data, type, full) {
                     return '<button class="btn btn-danger  btn-animate btn-animate-side btn-block btn-sm" onclick="delete_item('+data.id+')"> Delete </button>' ;
                 }
                }
            ]
        } );
...
document.getElementById("item_price").value = data[0].item_price;
