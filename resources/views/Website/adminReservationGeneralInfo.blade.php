...
<div class="col-lg-6">
    <div class="panel panel-border panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">Room Reservation Settings</h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="timepicker1" class="form-control" type="time" value="{{ $general_info->check_in }}" disabled >
                    </div>

                    <div class="col-md-3">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('chk_in')">Edit</button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input id="timepicker2" class="form-control" type="time" value="{{ $general_info->check_out }}" disabled>
                    </div>

                    <div class="col-md-3">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('chk_out')" >Edit</button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6  ">  <input class="form-control" disabled value=" {{ $general_info->no_of_adults}}"> </div>



                    <div class="col-md-3">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('adults')">Edit</button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-3 control-label"> Max Kids  </label>



                    <div class="col-md-6">
                        <input class="form-control" value="   {{ $general_info->no_of_kids}}" disabled>
                    </div>

                    <div class="col-md-3">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('kids')">Edit</button>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-md-3 control-label">  Selectable Rooms  </label>




                    <div class="col-md-6">
                        <input class="form-control" value=" {{ $general_info->selectable_no_of_rooms}}" disabled>
                    </div>

                    <div class="col-md-3">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('rooms')">Edit</button>
                    </div>
...
<div class="col-lg-6">
    <div class="panel panel-border panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">Hall Reservation Settings</h3>
        </div>
        ...
        <div class="panel-body">
            <form class="form-horizontal">
                <!-- hall tab--->
                <div class="panel-heading">
            <h4 class="panel-title">Time Slot 1</h4>
                </div>
              <br>
                <div class="form-group">

                    <label class="col-md-4 control-label"> From  </label>
                    <div class="col-md-8" id="time_slot_1">
                        <input id="time_slot_1_non_from" class="form-control" type="time" value="{{ $general_info->hall_time_slot_1_from }}" disabled >
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                         <input id="time_slot_1_non_to" class="form-control" type="time" value="{{ $general_info->hall_time_slot_1_to }}" disabled >
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-md-3 col-md-offset-9">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('hall_time1')">Edit</button>
                    </div>
                </div>
                 ...
                 <div class="panel-heading">
            <h4 class="panel-title">Time Slot 2</h4>
                </div>
              <br>
  ...
  <label class="col-md-4 control-label"> From  </label>
                    <div class="col-md-8">
                        <input id="time_slot_2_non_from"  class="form-control" type="time" value="{{ $general_info->hall_time_slot_2_from  }} "readonly >
                    </div>
  ...
  <label class="col-md-4 control-label"> To  </label>
                    <div class="col-md-8">
                                    <input id="time_slot_2_non_to" class="form-control" type="time" value="{{ $general_info->hall_time_slot_2_to  }}" readonly>
  ...
  <div class="form-group">
       ...
       <div class="col-md-3 col-md-offset-9">
                        <button type="button" class="btn btn-block btn-primary" onclick="editCHKIN('hall_time2')">Edit</button>
                    </div>
